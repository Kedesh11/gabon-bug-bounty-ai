        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="space-y-1">
            <h1 className="text-3xl font-black text-foreground tracking-tighter flex items-center gap-3">
              Elite Center <span className="text-primary font-mono text-sm px-2 py-0.5 bg-primary/10 border border-primary/20 rounded uppercase tracking-widest">Active</span>
            </h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
              <div className="lg:col-span-3 glass-card rounded-2xl border border-border overflow-hidden">
                <div className="p-5 border-b border-border bg-secondary/30 flex items-center justify-between">
                  ...
                  <Button variant="ghost" size="sm" className="text-[10px] font-bold h-7">TOUT VOIR</Button>
                </div>
              ...
              <div className="lg:col-span-2 glass-card rounded-2xl border border-border p-6 space-y-6">
                ...
                <Button variant="outline" className="w-full text-[10px] font-black tracking-widest uppercase">Voir plus de programmes</Button>
              </div>
            </div>
          </div>
